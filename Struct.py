...
class Struct:
    ...
    @classmethod
    def string(cls, length, offset=0, encoding=None, strip_nulls=False, value=''):
        return StructType(('string', (length, offset, encoding, strip_nulls, value)))
    ...
    def __len__(self):
        ...
        for i in range(len(self.__defs__)):
            ...
            if sdef == Struct.string:
                size, offset, encoding, strip_nulls, value = size
